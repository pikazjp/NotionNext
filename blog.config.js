...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '99b4e6f1a13845839f004abf7940b7e3',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '多爸', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '多爸', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fopchina.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'FOP,进行性骨化性纤维发育不良', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pikazjp@gmail.com', // 邮箱地址 例如mail@tangly1024.com
